# ConFusion: Mobile App for a Restaurant, Developed using React Native and Redux
...
-   Project involved Creating the UI for a restaurant application Using React Native
...
$ json-server --host 192.*.*.*.* --watch db.json -p 3001 -d 2000
```
